...
CREATE INDEX IF NOT EXISTS sindkdc2220402 ON keplersc.kdc22204 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2220403 ON keplersc.kdc22204 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2220404 ON keplersc.kdc22204 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE INDEX IF NOT EXISTS sindkdc2220406 ON keplersc.kdc22204 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE TRIGGER kdc22204_upd_saldos_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22204 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
