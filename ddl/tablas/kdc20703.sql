CREATE  TABLE keplersc.kdc20703 (
...
ALTER TABLE ONLY keplersc.kdc20703 ADD CONSTRAINT pk_kdc20703 PRIMARY KEY (c3, c2, c8, c1, c10);
CREATE INDEX IF NOT EXISTS kdc20703_c13_c2_c3_c8_c1_c10_idx ON keplersc.kdc20703 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc20703_c14_c15_c16_c17_c18_c19_c8_c1_c10_idx ON keplersc.kdc20703 USING btree (c14, c15, c16, c17, c18, c19, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc20703_c21_c2_c3_c8_c1_c10_idx ON keplersc.kdc20703 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc20703_c2_c8_c1_c10_idx ON keplersc.kdc20703 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE UNIQUE INDEX IF NOT EXISTS kdc20703_c3_c2_c8_c1_c10_idx ON keplersc.kdc20703 USING btree (c3, c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc20703_c8_c1_c10_idx ON keplersc.kdc20703 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2070305 ON keplersc.kdc20703 USING btree (c14, c15, c16, c17, c18, c19, c8, c1, c10) TABLESPACE pg_default;
COMMENT ON COLUMN keplersc.kdc20703.c9 IS 'Monto en moneda de origen';
COMMENT ON COLUMN keplersc.kdc20703.c8 IS 'Tipo de póliza';
COMMENT ON COLUMN keplersc.kdc20703.c7 IS 'Referencia';
COMMENT ON COLUMN keplersc.kdc20703.c6 IS 'Descripción de la póliza';
COMMENT ON COLUMN keplersc.kdc20703.c50 IS 'Graba para IETU';
COMMENT ON COLUMN keplersc.kdc20703.c5 IS 'Monto';
COMMENT ON COLUMN keplersc.kdc20703.c4 IS 'C=cargo A=abono';
COMMENT ON COLUMN keplersc.kdc20703.c32 IS 'Hora de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc20703.c31 IS 'Fecha de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc20703.c30 IS 'Ultimo usuario que modifico la poliza';
COMMENT ON COLUMN keplersc.kdc20703.c3 IS 'Número de cuenta';
COMMENT ON COLUMN keplersc.kdc20703.c22 IS 'Referencia para conciliación bancaria (cta cheques)';
COMMENT ON COLUMN keplersc.kdc20703.c21 IS 'Clave del proyecto';
COMMENT ON COLUMN keplersc.kdc20703.c20 IS 'Clave del concepto';
COMMENT ON COLUMN keplersc.kdc20703.c2 IS 'Fecha';
COMMENT ON COLUMN keplersc.kdc20703.c19 IS 'Folio';
COMMENT ON COLUMN keplersc.kdc20703.c18 IS 'Tipo';
COMMENT ON COLUMN keplersc.kdc20703.c17 IS 'Grupo';
COMMENT ON COLUMN keplersc.kdc20703.c16 IS 'Naturaleza';
COMMENT ON COLUMN keplersc.kdc20703.c15 IS 'Género';
COMMENT ON COLUMN keplersc.kdc20703.c14 IS 'Sucursal';
COMMENT ON COLUMN keplersc.kdc20703.c11 IS 'Clave del departamento';
COMMENT ON COLUMN keplersc.kdc20703.c10 IS 'Número consecutivo de partida';
COMMENT ON COLUMN keplersc.kdc20703.c1 IS 'Número de póliza';
CREATE TRIGGER kdc20703_upd_nivel_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc20703 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
