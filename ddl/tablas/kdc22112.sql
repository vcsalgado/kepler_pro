...
CREATE INDEX IF NOT EXISTS sindkdc2211202 ON keplersc.kdc22112 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2211203 ON keplersc.kdc22112 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2211204 ON keplersc.kdc22112 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2211206 ON keplersc.kdc22112 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE TRIGGER kdc22112_upd_saldos_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22112 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
