CREATE  TABLE keplersc.kdc22208 (
...
COMMENT ON COLUMN keplersc.kdc22208.c6 IS 'Descripción de la póliza';
COMMENT ON COLUMN keplersc.kdc22208.c50 IS 'Graba para IETU';
COMMENT ON COLUMN keplersc.kdc22208.c5 IS 'Monto';
COMMENT ON COLUMN keplersc.kdc22208.c4 IS 'C=cargo A=abono';
COMMENT ON COLUMN keplersc.kdc22208.c32 IS 'Hora de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc22208.c31 IS 'Fecha de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc22208.c30 IS 'Ultimo usuario que modifico la poliza';
COMMENT ON COLUMN keplersc.kdc22208.c3 IS 'Número de cuenta';
COMMENT ON COLUMN keplersc.kdc22208.c22 IS 'Referencia para conciliación bancaria (cta cheques)';
COMMENT ON COLUMN keplersc.kdc22208.c21 IS 'Clave del proyecto';
COMMENT ON COLUMN keplersc.kdc22208.c20 IS 'Clave del concepto';
COMMENT ON COLUMN keplersc.kdc22208.c2 IS 'Fecha';
COMMENT ON COLUMN keplersc.kdc22208.c19 IS 'Folio';
COMMENT ON COLUMN keplersc.kdc22208.c18 IS 'Tipo';
COMMENT ON COLUMN keplersc.kdc22208.c17 IS 'Grupo';
COMMENT ON COLUMN keplersc.kdc22208.c16 IS 'Naturaleza';
COMMENT ON COLUMN keplersc.kdc22208.c15 IS 'Género';
COMMENT ON COLUMN keplersc.kdc22208.c14 IS 'Sucursal';
