...
CREATE INDEX IF NOT EXISTS sindkdc2211002 ON keplersc.kdc22110 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2211003 ON keplersc.kdc22110 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2211004 ON keplersc.kdc22110 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE INDEX IF NOT EXISTS sindkdc2211006 ON keplersc.kdc22110 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE TRIGGER kdc22110_upd_saldos_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22110 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
