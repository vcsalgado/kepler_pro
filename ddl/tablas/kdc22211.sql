...
CREATE INDEX IF NOT EXISTS sindkdc2221102 ON keplersc.kdc22211 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2221103 ON keplersc.kdc22211 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2221104 ON keplersc.kdc22211 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE INDEX IF NOT EXISTS sindkdc2221106 ON keplersc.kdc22211 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE TRIGGER kdc22211_upd_saldos_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22211 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
