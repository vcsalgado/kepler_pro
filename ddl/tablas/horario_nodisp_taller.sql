...
CREATE UNIQUE INDEX IF NOT EXISTS horario_nodisp_taller_sucursal_idx ON keplersc.horario_nodisp_taller USING btree (sucursal, fecha, horario_nodisp_inicio, horario_nodisp_fin) TABLESPACE pg_default;
