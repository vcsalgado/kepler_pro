CREATE  TABLE keplersc.kdc22105 (
  ...
  c19 character varying NOT NULL DEFAULT ''::character varying,
...
CREATE INDEX IF NOT EXISTS sindkdc2210502 ON keplersc.kdc22105 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2210503 ON keplersc.kdc22105 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2210504 ON keplersc.kdc22105 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE INDEX IF NOT EXISTS sindkdc2210506 ON keplersc.kdc22105 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE TRIGGER kdc22105_upd_saldos_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22105 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
