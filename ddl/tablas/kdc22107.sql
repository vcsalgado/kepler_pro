...
CREATE INDEX IF NOT EXISTS sindkdc2210702 ON keplersc.kdc22107 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2210703 ON keplersc.kdc22107 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2210704 ON keplersc.kdc22107 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2210706 ON keplersc.kdc22107 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE TRIGGER kdc22107_upd_saldos_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22107 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
