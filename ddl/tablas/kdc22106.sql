...
CREATE INDEX IF NOT EXISTS sindkdc2210602 ON keplersc.kdc22106 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2210603 ON keplersc.kdc22106 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2210604 ON keplersc.kdc22106 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE INDEX IF NOT EXISTS sindkdc2210606 ON keplersc.kdc22106 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE TRIGGER kdc22106_upd_saldos_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22106 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
