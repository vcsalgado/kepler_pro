...
CREATE INDEX IF NOT EXISTS sindkdc2220202 ON keplersc.kdc22202 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2220203 ON keplersc.kdc22202 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2220204 ON keplersc.kdc22202 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE INDEX IF NOT EXISTS sindkdc2220206 ON keplersc.kdc22202 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE TRIGGER kdc22202_upd_saldos_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22202 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
