...
CREATE INDEX IF NOT EXISTS sindkdc2220602 ON keplersc.kdc22206 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2220603 ON keplersc.kdc22206 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2220604 ON keplersc.kdc22206 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE INDEX IF NOT EXISTS sindkdc2220606 ON keplersc.kdc22206 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
...
CREATE TRIGGER kdc22206_upd_saldos_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22206 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
