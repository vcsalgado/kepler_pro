CREATE  TABLE keplersc.job_correos (
  job_correo integer GENERATED ALWAYS AS IDENTITY NOT NULL,
  destinatarios character varying NOT NULL DEFAULT ''::character varying,
  copiapara character varying NOT NULL DEFAULT ''::character varying,
  asunto character varying NOT NULL DEFAULT ''::character varying,
