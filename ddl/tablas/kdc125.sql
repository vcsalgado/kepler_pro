...
COMMENT ON COLUMN keplersc.kdc125.c86 IS 'suma de abonos en d�lares en el mes 12';
COMMENT ON COLUMN keplersc.kdc125.c85 IS 'suma de abonos en d�lares en el mes 11';
COMMENT ON COLUMN keplersc.kdc125.c84 IS 'suma de abonos en d�lares en el mes 10';
COMMENT ON COLUMN keplersc.kdc125.c83 IS 'suma de abonos en d�lares en el mes 9';
COMMENT ON COLUMN keplersc.kdc125.c82 IS 'suma de abonos en d�lares en el mes 8';
COMMENT ON COLUMN keplersc.kdc125.c81 IS 'suma de abonos en d�lares en el mes 7';
COMMENT ON COLUMN keplersc.kdc125.c80 IS 'suma de abonos en d�lares en el mes 6';
COMMENT ON COLUMN keplersc.kdc125.c79 IS 'suma de abonos en d�lares en el mes 5';
COMMENT ON COLUMN keplersc.kdc125.c78 IS 'suma de abonos en d�lares en el mes 4';
COMMENT ON COLUMN keplersc.kdc125.c77 IS 'suma de abonos en d�lares en el mes 3';
COMMENT ON COLUMN keplersc.kdc125.c76 IS 'suma de abonos en d�lares en el mes 2';
COMMENT ON COLUMN keplersc.kdc125.c75 IS 'suma de abonos en d�lares en el mes 1';
...
COMMENT ON COLUMN keplersc.kdc125.c7 IS 'Clave de la moneda DLL=d�lares PES=nuevos pesos';
...
COMMENT ON COLUMN keplersc.kdc125.c62 IS 'saldo en d�lares del mes diciembre';
COMMENT ON COLUMN keplersc.kdc125.c61 IS 'saldo en d�lares del mes noviembre';
COMMENT ON COLUMN keplersc.kdc125.c60 IS 'saldo en d�lares del mes octubre';
COMMENT ON COLUMN keplersc.kdc125.c6 IS 'Naturaleza D=Deudora A=Acreedora';
COMMENT ON COLUMN keplersc.kdc125.c59 IS 'saldo en d�lares del mes septiembre';
COMMENT ON COLUMN keplersc.kdc125.c58 IS 'saldo en d�lares del mes agosto';
COMMENT ON COLUMN keplersc.kdc125.c57 IS 'saldo en d�lares del mes julio';
COMMENT ON COLUMN keplersc.kdc125.c56 IS 'saldo en d�lares del mes junio';
COMMENT ON COLUMN keplersc.kdc125.c55 IS 'saldo en d�lares del mes mayo';
COMMENT ON COLUMN keplersc.kdc125.c54 IS 'saldo en d�lares del mes abril';
COMMENT ON COLUMN keplersc.kdc125.c53 IS 'saldo en d�lares del mes marzo';
COMMENT ON COLUMN keplersc.kdc125.c52 IS 'saldo en d�lares del mes febrero';
COMMENT ON COLUMN keplersc.kdc125.c51 IS 'saldo en d�lares del mes enero';
...
COMMENT ON COLUMN keplersc.kdc125.c26 IS 'saldo a�o anterior diciembre';
COMMENT ON COLUMN keplersc.kdc125.c25 IS 'saldo a�o anterior noviembre';
COMMENT ON COLUMN keplersc.kdc125.c24 IS 'saldo a�o anterior octubre';
COMMENT ON COLUMN keplersc.kdc125.c23 IS 'saldo a�o anterior septiembre';
COMMENT ON COLUMN keplersc.kdc125.c22 IS 'saldo a�o anterior agosto';
COMMENT ON COLUMN keplersc.kdc125.c21 IS 'saldo a�o anterior julio';
COMMENT ON COLUMN keplersc.kdc125.c20 IS 'saldo a�o anterior junio';
COMMENT ON COLUMN keplersc.kdc125.c2 IS 'Descripci�n de la cuenta';
COMMENT ON COLUMN keplersc.kdc125.c19 IS 'saldo a�o anterior mayo';
COMMENT ON COLUMN keplersc.kdc125.c18 IS 'saldo a�o anterior abril';
COMMENT ON COLUMN keplersc.kdc125.c17 IS 'saldo a�o anterior marzo';
COMMENT ON COLUMN keplersc.kdc125.c16 IS 'saldo a�o anterior febrero';
COMMENT ON COLUMN keplersc.kdc125.c15 IS 'saldo a�o anterior enero';
COMMENT ON COLUMN keplersc.kdc125.c14 IS 'Saldo inicial pesos';
COMMENT ON COLUMN keplersc.kdc125.c11 IS 'Saldo inicial d�lares';
