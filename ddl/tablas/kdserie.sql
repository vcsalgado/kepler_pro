CREATE  TABLE keplersc.kdserie (
  ...
  c18 character varying(20) NULL DEFAULT 0,
  ...
  fec_ultima_modif timestamp without time zone NOT NULL DEFAULT '1800-01-01 00:00:00'::timestamp without time zone,
  usuario_ultima_modif character varying(20) NOT NULL DEFAULT ''::character varying,
  notas character varying(1000) NOT NULL DEFAULT ''::character varying
...
COMMENT ON COLUMN keplersc.kdserie.usuario_ultima_modif IS 'Usuario realizo ultima modificacion';
...
COMMENT ON COLUMN keplersc.kdserie.notas IS 'Notas generales';
COMMENT ON COLUMN keplersc.kdserie.fecha_ult_contacto_tmkt IS 'Fecha Ultimo Contacto TMKT';
COMMENT ON COLUMN keplersc.kdserie.fec_ultima_modif IS 'Fecha ultima modificacion del registro';
