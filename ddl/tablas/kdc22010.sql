CREATE  TABLE keplersc.kdc22010 (
...
ALTER TABLE ONLY keplersc.kdc22010 ADD CONSTRAINT pk_kdc22010 PRIMARY KEY (c3, c2, c8, c1, c10);
CREATE INDEX IF NOT EXISTS kdc22010_c13_c2_c3_c8_c1_c10_idx ON keplersc.kdc22010 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc22010_c14_c15_c16_c17_c18_c19_c8_c1_c10_idx ON keplersc.kdc22010 USING btree (c14, c15, c16, c17, c18, c19, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc22010_c21_c2_c3_c8_c1_c10_idx ON keplersc.kdc22010 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc22010_c2_c8_c1_c10_idx ON keplersc.kdc22010 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE UNIQUE INDEX IF NOT EXISTS kdc22010_c3_c2_c8_c1_c10_idx ON keplersc.kdc22010 USING btree (c3, c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc22010_c8_c1_c10_idx ON keplersc.kdc22010 USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc2201005 ON keplersc.kdc22010 USING btree (c14, c15, c16, c17, c18, c19, c8, c1, c10) TABLESPACE pg_default;
COMMENT ON COLUMN keplersc.kdc22010.c9 IS 'Monto en moneda de origen';
COMMENT ON COLUMN keplersc.kdc22010.c8 IS 'Tipo de póliza';
COMMENT ON COLUMN keplersc.kdc22010.c7 IS 'Referencia';
COMMENT ON COLUMN keplersc.kdc22010.c6 IS 'Descripción de la póliza';
COMMENT ON COLUMN keplersc.kdc22010.c50 IS 'Graba para IETU';
COMMENT ON COLUMN keplersc.kdc22010.c5 IS 'Monto';
COMMENT ON COLUMN keplersc.kdc22010.c4 IS 'C=cargo A=abono';
COMMENT ON COLUMN keplersc.kdc22010.c32 IS 'Hora de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc22010.c31 IS 'Fecha de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc22010.c30 IS 'Ultimo usuario que modifico la poliza';
COMMENT ON COLUMN keplersc.kdc22010.c3 IS 'Número de cuenta';
COMMENT ON COLUMN keplersc.kdc22010.c22 IS 'Referencia para conciliación bancaria (cta cheques)';
COMMENT ON COLUMN keplersc.kdc22010.c21 IS 'Clave del proyecto';
COMMENT ON COLUMN keplersc.kdc22010.c20 IS 'Clave del concepto';
COMMENT ON COLUMN keplersc.kdc22010.c2 IS 'Fecha';
COMMENT ON COLUMN keplersc.kdc22010.c19 IS 'Folio';
COMMENT ON COLUMN keplersc.kdc22010.c18 IS 'Tipo';
COMMENT ON COLUMN keplersc.kdc22010.c17 IS 'Grupo';
COMMENT ON COLUMN keplersc.kdc22010.c16 IS 'Naturaleza';
COMMENT ON COLUMN keplersc.kdc22010.c15 IS 'Género';
COMMENT ON COLUMN keplersc.kdc22010.c14 IS 'Sucursal';
COMMENT ON COLUMN keplersc.kdc22010.c11 IS 'Clave del departamento';
COMMENT ON COLUMN keplersc.kdc22010.c10 IS 'Número consecutivo de partida';
COMMENT ON COLUMN keplersc.kdc22010.c1 IS 'Número de póliza';
CREATE TRIGGER kdc22010_upd_nivel_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22010 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
