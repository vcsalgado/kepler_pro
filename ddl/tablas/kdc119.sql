...
CREATE UNIQUE INDEX IF NOT EXISTS kdc119_c1_idx ON keplersc.kdc119 USING btree (c1) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc119_c2_c1_idx ON keplersc.kdc119 USING btree (c2, c1) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS kdc119_c3_c1_idx ON keplersc.kdc119 USING btree (c3, c1) TABLESPACE pg_default;
...
COMMENT ON COLUMN keplersc.kdc119.c86 IS 'suma de abonos en dólares en el mes 12';
COMMENT ON COLUMN keplersc.kdc119.c85 IS 'suma de abonos en dólares en el mes 11';
COMMENT ON COLUMN keplersc.kdc119.c84 IS 'suma de abonos en dólares en el mes 10';
COMMENT ON COLUMN keplersc.kdc119.c83 IS 'suma de abonos en dólares en el mes 9';
COMMENT ON COLUMN keplersc.kdc119.c82 IS 'suma de abonos en dólares en el mes 8';
COMMENT ON COLUMN keplersc.kdc119.c81 IS 'suma de abonos en dólares en el mes 7';
COMMENT ON COLUMN keplersc.kdc119.c80 IS 'suma de abonos en dólares en el mes 6';
COMMENT ON COLUMN keplersc.kdc119.c79 IS 'suma de abonos en dólares en el mes 5';
COMMENT ON COLUMN keplersc.kdc119.c78 IS 'suma de abonos en dólares en el mes 4';
COMMENT ON COLUMN keplersc.kdc119.c77 IS 'suma de abonos en dólares en el mes 3';
COMMENT ON COLUMN keplersc.kdc119.c76 IS 'suma de abonos en dólares en el mes 2';
COMMENT ON COLUMN keplersc.kdc119.c75 IS 'suma de abonos en dólares en el mes 1';
...
COMMENT ON COLUMN keplersc.kdc119.c7 IS 'Clave de la moneda DLL=dólares PES=nuevos pesos';
...
COMMENT ON COLUMN keplersc.kdc119.c62 IS 'saldo en dólares del mes diciembre';
COMMENT ON COLUMN keplersc.kdc119.c61 IS 'saldo en dólares del mes noviembre';
COMMENT ON COLUMN keplersc.kdc119.c60 IS 'saldo en dólares del mes octubre';
COMMENT ON COLUMN keplersc.kdc119.c6 IS 'Naturaleza D=Deudora A=Acreedora';
COMMENT ON COLUMN keplersc.kdc119.c59 IS 'saldo en dólares del mes septiembre';
COMMENT ON COLUMN keplersc.kdc119.c58 IS 'saldo en dólares del mes agosto';
COMMENT ON COLUMN keplersc.kdc119.c57 IS 'saldo en dólares del mes julio';
COMMENT ON COLUMN keplersc.kdc119.c56 IS 'saldo en dólares del mes junio';
COMMENT ON COLUMN keplersc.kdc119.c55 IS 'saldo en dólares del mes mayo';
COMMENT ON COLUMN keplersc.kdc119.c54 IS 'saldo en dólares del mes abril';
COMMENT ON COLUMN keplersc.kdc119.c53 IS 'saldo en dólares del mes marzo';
COMMENT ON COLUMN keplersc.kdc119.c52 IS 'saldo en dólares del mes febrero';
COMMENT ON COLUMN keplersc.kdc119.c51 IS 'saldo en dólares del mes enero';
...
COMMENT ON COLUMN keplersc.kdc119.c26 IS 'saldo año anterior diciembre';
COMMENT ON COLUMN keplersc.kdc119.c25 IS 'saldo año anterior noviembre';
COMMENT ON COLUMN keplersc.kdc119.c24 IS 'saldo año anterior octubre';
COMMENT ON COLUMN keplersc.kdc119.c23 IS 'saldo año anterior septiembre';
COMMENT ON COLUMN keplersc.kdc119.c22 IS 'saldo año anterior agosto';
COMMENT ON COLUMN keplersc.kdc119.c21 IS 'saldo año anterior julio';
COMMENT ON COLUMN keplersc.kdc119.c20 IS 'saldo año anterior junio';
COMMENT ON COLUMN keplersc.kdc119.c2 IS 'Descripción de la cuenta';
COMMENT ON COLUMN keplersc.kdc119.c19 IS 'saldo año anterior mayo';
COMMENT ON COLUMN keplersc.kdc119.c18 IS 'saldo año anterior abril';
COMMENT ON COLUMN keplersc.kdc119.c17 IS 'saldo año anterior marzo';
COMMENT ON COLUMN keplersc.kdc119.c16 IS 'saldo año anterior febrero';
COMMENT ON COLUMN keplersc.kdc119.c15 IS 'saldo año anterior enero';
COMMENT ON COLUMN keplersc.kdc119.c14 IS 'Saldo inicial pesos';
COMMENT ON COLUMN keplersc.kdc119.c11 IS 'Saldo inicial dólares';
COMMENT ON COLUMN keplersc.kdc119.c100 IS 'Afecta IETU';
COMMENT ON COLUMN keplersc.kdc119.c1 IS 'No. de cuenta';
CREATE TRIGGER kdc1_upd_nivel_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc119 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_nivel();
