...
COMMENT ON COLUMN keplersc.kdc119.c86 IS 'suma de abonos en dolares en el mes 12';
COMMENT ON COLUMN keplersc.kdc119.c85 IS 'suma de abonos en dolares en el mes 11';
COMMENT ON COLUMN keplersc.kdc119.c84 IS 'suma de abonos en dolares en el mes 10';
COMMENT ON COLUMN keplersc.kdc119.c83 IS 'suma de abonos en dolares en el mes 9';
COMMENT ON COLUMN keplersc.kdc119.c82 IS 'suma de abonos en dolares en el mes 8';
COMMENT ON COLUMN keplersc.kdc119.c81 IS 'suma de abonos en dolares en el mes 7';
COMMENT ON COLUMN keplersc.kdc119.c80 IS 'suma de abonos en dolares en el mes 6';
COMMENT ON COLUMN keplersc.kdc119.c79 IS 'suma de abonos en dolares en el mes 5';
COMMENT ON COLUMN keplersc.kdc119.c78 IS 'suma de abonos en dolares en el mes 4';
COMMENT ON COLUMN keplersc.kdc119.c77 IS 'suma de abonos en dolares en el mes 3';
COMMENT ON COLUMN keplersc.kdc119.c76 IS 'suma de abonos en dolares en el mes 2';
COMMENT ON COLUMN keplersc.kdc119.c75 IS 'suma de abonos en dolares en el mes 1';
...
COMMENT ON COLUMN keplersc.kdc119.c7 IS 'Clave de la moneda DLL=dolares PES=nuevos pesos';
...
COMMENT ON COLUMN keplersc.kdc119.c62 IS 'saldo en dolares del mes diciembre';
COMMENT ON COLUMN keplersc.kdc119.c61 IS 'saldo en dolares del mes noviembre';
COMMENT ON COLUMN keplersc.kdc119.c60 IS 'saldo en dolares del mes octubre';
COMMENT ON COLUMN keplersc.kdc119.c6 IS 'Naturaleza D=Deudora A=Acreedora';
COMMENT ON COLUMN keplersc.kdc119.c59 IS 'saldo en dolares del mes septiembre';
COMMENT ON COLUMN keplersc.kdc119.c58 IS 'saldo en dolares del mes agosto';
COMMENT ON COLUMN keplersc.kdc119.c57 IS 'saldo en dolares del mes julio';
COMMENT ON COLUMN keplersc.kdc119.c56 IS 'saldo en dolares del mes junio';
COMMENT ON COLUMN keplersc.kdc119.c55 IS 'saldo en dolares del mes mayo';
COMMENT ON COLUMN keplersc.kdc119.c54 IS 'saldo en dolares del mes abril';
COMMENT ON COLUMN keplersc.kdc119.c53 IS 'saldo en dolares del mes marzo';
COMMENT ON COLUMN keplersc.kdc119.c52 IS 'saldo en dolares del mes febrero';
COMMENT ON COLUMN keplersc.kdc119.c51 IS 'saldo en dolares del mes enero';
...
COMMENT ON COLUMN keplersc.kdc119.c11 IS 'Saldo inicial dolares';
