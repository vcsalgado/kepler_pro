...
--Codigo temporal para que cierren ordenes con el factor de precio por hora de 2024 para ordenes en especfico 
if  folio_orden='0000059908' or folio_orden='0000060116' or folio_orden='0000059262' or folio_orden='0000060041' then
				
	costo_por_hora_default=240;
end if;
