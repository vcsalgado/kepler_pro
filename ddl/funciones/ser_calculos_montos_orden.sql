...
--Codigo temporal para que cierren ordenes con el factor de precio por hora de 2025 para ordenes en especfico 
if  tipo_orden='H' and folio_orden='0000121126' then	--(folio_orden='0000121091' or folio_orden='0000121208')
				
	costo_por_hora_default=280;
end if;
