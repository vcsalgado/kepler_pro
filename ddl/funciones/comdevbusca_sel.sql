...
begin	
	...
	'
	select tuxg.c3 as k_clave/*k_claveprov*/, txd.c3 as nombre, tuxg.c4 as documento, tuxg.c11 as k_fecha/*fecha_exp*/, 
	...
	from keplersc.kdm1 tdm1 
		...
		and lpad(tdm1.c11,10,%1$L) = tuxe.c3 
	...
	, tdm2.c13 as k_monto/*k_importe*/, tdm2.c17 as ivaperce, tdm2.c27 as costovtapartida 
	, lpad(tdm1.c11,10,%8$L) as refer, tdm1.c6 as folio 
