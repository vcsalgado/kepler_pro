CREATE OR REPLACE FUNCTION keplersc.autos_baja_anticipo_cons(dataxml xml)
 RETURNS TABLE(encabezado xml)
 LANGUAGE plpgsql
AS $function$
declare
--Descripcion: Obtiene en formato XML el detalle de un folio a consultar de una baja de anticipo
