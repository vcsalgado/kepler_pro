CREATE OR REPLACE FUNCTION keplersc.ser_fact_orden_cons(dataxml xml)
 RETURNS TABLE(encabezado xml)
 LANGUAGE plpgsql
AS $function$
declare
--Descripcion: Obtiene en formato XML el detalle de un folio a consultar de una orden facturada
