CREATE OR REPLACE FUNCTION keplersc.com_objlinea_crud(dataxml xml)
 RETURNS TABLE(resultado text, mensaje text, adicionales text)
 LANGUAGE plpgsql
AS $function$
declare
	--Descripcion. Función para actualizar la tabla kdbonolineacoaches 
...
begin
	...
	delete from keplersc.kdbonolineacoaches 
	...
	for cont in 0..no_partidas loop
		...
		insert into keplersc.kdbonolineacoaches(c1,c2,c3,c4,c5,c6,c7)
			values(sucursal_id,esquema,linea,anio,mes,objetivo,bono);
	end loop;
