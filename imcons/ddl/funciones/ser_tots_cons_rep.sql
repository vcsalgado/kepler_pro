CREATE OR REPLACE FUNCTION keplersc.ser_tots_cons_rep(dataxml xml)
 RETURNS TABLE(encabezado xml, detpartidas xml)
 LANGUAGE plpgsql
AS $function$
declare
--Descripcion: Obtiene en formato XML el encabezado y detalle de los movimientos de TOTs con los datos requeridos para el reporte
...
expSql= format('
select tot.c2 as k_tipo_orden, mar.c3 as k_desc_tipo, tot.c3 as k_num_orden, tot.c4 as k_punto, pun.C8 as k_desc_punto, tot.c10 as k_descriptot,tot.c11 as k_costo, tot.c16 as k_precio, mar.c6 as k_margtots , 
(tot.c16-tot.c11)/tot.c11*100 as k_marg_calc, substring(ord.c11,1,20) as k_cliente
...
inner join keplersc.kdord ord on ord.c1=tot.c1 and ord.c2=tot.c2 and ord.c3=tot.c3 
where dm1.c1 = %1$L and dm1.c2 = %2$L and dm1.c3 = %3$L and dm1.c4 = %4$s and dm1.c5 = %5$s and dm1.c6 = %6$L  
',sucursal_id,genero,naturaleza,grupo,tipo,folio);
