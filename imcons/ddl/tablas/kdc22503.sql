CREATE  TABLE keplersc.kdc22503 (
...
COMMENT ON COLUMN keplersc.kdc22503.c6 IS 'Descripción de la póliza';
COMMENT ON COLUMN keplersc.kdc22503.c50 IS 'Graba para IETU';
COMMENT ON COLUMN keplersc.kdc22503.c5 IS 'Monto';
COMMENT ON COLUMN keplersc.kdc22503.c4 IS 'C=cargo A=abono';
COMMENT ON COLUMN keplersc.kdc22503.c32 IS 'Hora de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc22503.c31 IS 'Fecha de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc22503.c30 IS 'Ultimo usuario que modifico la poliza';
COMMENT ON COLUMN keplersc.kdc22503.c3 IS 'Número de cuenta';
COMMENT ON COLUMN keplersc.kdc22503.c22 IS 'Referencia para conciliación bancaria (cta cheques)';
COMMENT ON COLUMN keplersc.kdc22503.c21 IS 'Clave del proyecto';
COMMENT ON COLUMN keplersc.kdc22503.c20 IS 'Clave del concepto';
COMMENT ON COLUMN keplersc.kdc22503.c2 IS 'Fecha';
COMMENT ON COLUMN keplersc.kdc22503.c19 IS 'Folio';
COMMENT ON COLUMN keplersc.kdc22503.c18 IS 'Tipo';
COMMENT ON COLUMN keplersc.kdc22503.c17 IS 'Grupo';
COMMENT ON COLUMN keplersc.kdc22503.c16 IS 'Naturaleza';
COMMENT ON COLUMN keplersc.kdc22503.c15 IS 'Género';
COMMENT ON COLUMN keplersc.kdc22503.c14 IS 'Sucursal';
COMMENT ON COLUMN keplersc.kdc22503.c11 IS 'Clave del departamento';
COMMENT ON COLUMN keplersc.kdc22503.c10 IS 'Número consecutivo de partida';
COMMENT ON COLUMN keplersc.kdc22503.c1 IS 'Número de póliza';
CREATE TRIGGER kdc22503_upd_nivel_after_crud AFTER INSERT OR DELETE OR UPDATE ON keplersc.kdc22503 FOR EACH ROW EXECUTE FUNCTION keplersc.cont_upd_saldos();
