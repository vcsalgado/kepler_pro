CREATE  TABLE keplersc.kdcpolizas (
  ...
  c49 character varying(4) NOT NULL DEFAULT ''::character varying,
  c50 character varying(1) NOT NULL DEFAULT ''::character varying
) TABLESPACE pg_default;
CREATE UNIQUE INDEX IF NOT EXISTS pk_kdcpolizas ON keplersc.kdcpolizas USING btree (c3, c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdcpolizas02 ON keplersc.kdcpolizas USING btree (c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdcpolizas03 ON keplersc.kdcpolizas USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdcpolizas04 ON keplersc.kdcpolizas USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdcpolizas05 ON keplersc.kdcpolizas USING btree (c14, c15, c16, c17, c18, c19, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdcpolizas06 ON keplersc.kdcpolizas USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
COMMENT ON TABLE keplersc.kdcpolizas IS 'Polizas Contables';
COMMENT ON COLUMN keplersc.kdcpolizas.c9 IS 'Monto en moneda de origen';
COMMENT ON COLUMN keplersc.kdcpolizas.c8 IS 'Tipo de póliza';
COMMENT ON COLUMN keplersc.kdcpolizas.c7 IS 'Referencia';
COMMENT ON COLUMN keplersc.kdcpolizas.c6 IS 'Descripción de la póliza';
COMMENT ON COLUMN keplersc.kdcpolizas.c50 IS 'Graba para IETU';
COMMENT ON COLUMN keplersc.kdcpolizas.c5 IS 'Monto';
COMMENT ON COLUMN keplersc.kdcpolizas.c49 IS 'Anio mes contable';
COMMENT ON COLUMN keplersc.kdcpolizas.c4 IS 'C=cargo A=abono';
COMMENT ON COLUMN keplersc.kdcpolizas.c32 IS 'Hora de ultima modificacion';
COMMENT ON COLUMN keplersc.kdcpolizas.c31 IS 'Fecha de ultima modificacion';
COMMENT ON COLUMN keplersc.kdcpolizas.c30 IS 'Ultimo usuario que modifico la poliza';
COMMENT ON COLUMN keplersc.kdcpolizas.c3 IS 'Número de cuenta';
COMMENT ON COLUMN keplersc.kdcpolizas.c22 IS 'Referencia para conciliación bancaria (cta cheques)';
COMMENT ON COLUMN keplersc.kdcpolizas.c21 IS 'Clave del proyecto';
COMMENT ON COLUMN keplersc.kdcpolizas.c20 IS 'Clave del concepto';
COMMENT ON COLUMN keplersc.kdcpolizas.c2 IS 'Fecha';
COMMENT ON COLUMN keplersc.kdcpolizas.c19 IS 'Folio';
COMMENT ON COLUMN keplersc.kdcpolizas.c18 IS 'Tipo';
COMMENT ON COLUMN keplersc.kdcpolizas.c17 IS 'Grupo';
COMMENT ON COLUMN keplersc.kdcpolizas.c16 IS 'Naturaleza';
COMMENT ON COLUMN keplersc.kdcpolizas.c15 IS 'Género';
COMMENT ON COLUMN keplersc.kdcpolizas.c14 IS 'Sucursal';
COMMENT ON COLUMN keplersc.kdcpolizas.c11 IS 'Clave del departamento';
COMMENT ON COLUMN keplersc.kdcpolizas.c10 IS 'Número consecutivo de partida';
COMMENT ON COLUMN keplersc.kdcpolizas.c1 IS 'Número de póliza';
