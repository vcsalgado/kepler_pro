...
CREATE INDEX IF NOT EXISTS sindkdc203 ON keplersc.kdc2 USING btree (c2, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc204 ON keplersc.kdc2 USING btree (c13, c2, c3, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc205 ON keplersc.kdc2 USING btree (c14, c15, c16, c17, c18, c19, c8, c1, c10) TABLESPACE pg_default;
CREATE INDEX IF NOT EXISTS sindkdc206 ON keplersc.kdc2 USING btree (c21, c2, c3, c8, c1, c10) TABLESPACE pg_default;
COMMENT ON TABLE keplersc.kdc2 IS 'Polizas Contables';
COMMENT ON COLUMN keplersc.kdc2.c9 IS 'Monto en moneda de origen';
COMMENT ON COLUMN keplersc.kdc2.c8 IS 'Tipo de póliza';
COMMENT ON COLUMN keplersc.kdc2.c7 IS 'Referencia';
COMMENT ON COLUMN keplersc.kdc2.c6 IS 'Descripción de la póliza';
COMMENT ON COLUMN keplersc.kdc2.c50 IS 'Graba para IETU';
COMMENT ON COLUMN keplersc.kdc2.c5 IS 'Monto';
COMMENT ON COLUMN keplersc.kdc2.c4 IS 'C=cargo A=abono';
COMMENT ON COLUMN keplersc.kdc2.c32 IS 'Hora de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc2.c31 IS 'Fecha de ultima modificacion';
COMMENT ON COLUMN keplersc.kdc2.c30 IS 'Ultimo usuario que modifico la poliza';
COMMENT ON COLUMN keplersc.kdc2.c3 IS 'Número de cuenta';
COMMENT ON COLUMN keplersc.kdc2.c22 IS 'Referencia para conciliación bancaria (cta cheques)';
COMMENT ON COLUMN keplersc.kdc2.c21 IS 'Clave del proyecto';
COMMENT ON COLUMN keplersc.kdc2.c20 IS 'Clave del concepto';
COMMENT ON COLUMN keplersc.kdc2.c2 IS 'Fecha';
COMMENT ON COLUMN keplersc.kdc2.c19 IS 'Folio';
COMMENT ON COLUMN keplersc.kdc2.c18 IS 'Tipo';
COMMENT ON COLUMN keplersc.kdc2.c17 IS 'Grupo';
COMMENT ON COLUMN keplersc.kdc2.c16 IS 'Naturaleza';
COMMENT ON COLUMN keplersc.kdc2.c15 IS 'Género';
COMMENT ON COLUMN keplersc.kdc2.c14 IS 'Sucursal';
COMMENT ON COLUMN keplersc.kdc2.c11 IS 'Clave del departamento';
COMMENT ON COLUMN keplersc.kdc2.c10 IS 'Número consecutivo de partida';
COMMENT ON COLUMN keplersc.kdc2.c1 IS 'Número de póliza';
