CREATE  TABLE keplersc.kdtiemposnd (
  ...
  c9 character varying NOT NULL DEFAULT ''::character varying,
  c10 character varying NOT NULL DEFAULT ''::character varying
...
COMMENT ON COLUMN keplersc.kdtiemposnd.c9 IS 'Inicio horario no disp';
...
COMMENT ON COLUMN keplersc.kdtiemposnd.c2 IS 'TipoOperario/Asesor';
COMMENT ON COLUMN keplersc.kdtiemposnd.c10 IS 'Fin horario no disp';
COMMENT ON COLUMN keplersc.kdtiemposnd.c1 IS 'Operario/Asesor';
